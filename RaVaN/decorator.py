...
from RaVaN import BOT_USERNAME, dp
from RaVaN.config import get_bool_key
from RaVaN.modules.error import parse_update
from RaVaN.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("RaVaN.utils.filters." + module_name)
