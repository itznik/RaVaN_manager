# This file is part of RaVaN_Bot (Telegram Bot)
...
from RaVaN.services.events import register as RaVaN
from RaVaN.services.telethon import tbot
from RaVaN.services.telethonuserbot import ubot
...
async def _(event):
    ...
    packshortname = f"RaVaN_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if RaVaN steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"RaVaN_animated_{userid}"
