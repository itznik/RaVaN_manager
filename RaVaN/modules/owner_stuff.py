...
from RaVaN import DAISY_VERSION, OPERATORS, OWNER_ID, bot, dp
from RaVaN.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
from RaVaN.modules import LOADED_MODULES
from RaVaN.services.mongo import db, mongodb
...
async def restart_bot(message):
    await message.reply("RaVaN will be restarted...")
    args = [sys.executable, "-m", "RaVaN"]
...
async def stats(message):
    text = f"<b>RaVaN {DAISY_VERSION} stats</b>\n"
