...
from RaVaN.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/Itznik/RaVaN_manager/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/itznik_x"),
        InlineKeyboardButton("👥 Support Grup", url="https://t.me/itznik_x"),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add RaVaN to your group",
            url=f"https://telegram.me/RaVaN_manager_bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/RaVaN_manager_BOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
