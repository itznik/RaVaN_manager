...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("RaVaN.modules." + module_name)
...
import_module("RaVaN.modules.pm_menu")
# Import misc stuff
import_module("RaVaN.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("RaVaN.utils.sentry")
...
import_module("RaVaN.utils.db_structure_migrator")
