...
# Extra Plugins Provided By Team RaVaN X
...
from RaVaN.function.inlinehelper import (
    alive_function,
    arq,
    deezer_func,
    google_search_func,
...
from RaVaN.function.pluginhelpers import fetch, json_prettify
from RaVaN.services.pyrogram import pbot as app
from RaVaN.config import get_str_key
...
__MODULE__ = "Inline"
__HELP__ = """
 ==>> **INLINE BOT SERVICE OF @RaVaN_manager_BOT** <<==
    ...
    try:
        ...
        if text.strip() == "":
            ...
            if exc:
                ...
                evaluation = "Sorry RaVaN can't find result for the given equation"
