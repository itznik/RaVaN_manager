...
from RaVaN.function.pluginhelpers import admins_only, get_text
        ...
        for i, image in enumerate(images):
            ...
            try:
                ...
                try:
                    ...
                    with open("logo@RaVaN_manager_BOT.jpg", "wb+") as f:
                        f.write(r)
                    count += 1
            except:
                pass
...
async def logogen(client, message):
    ...
    try:
        ...
        typeo = "name"
        await pablo.edit(
            "Give name and type for logo Idiot. like `/logogen RaVaN:Robot`"
        )
    name = lmao[0]
    mainne(name, typeo)
    pate = "logo@RaVaN_manager_BOT.jpg"
